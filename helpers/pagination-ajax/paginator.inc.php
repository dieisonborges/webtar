...
$_pagi_cuantos = 50;            //quantidade de registros por pagina
$_pagi_nav_num_enlaces = 7;   // aqui você escolha a quantidade
...
$_pagi_nav_ultima = "&Uacute;ltima";        //string para última
...
if(empty($_pagi_sql)){
    ...
    die("<b>Erro de Paginacao : </b>No se ha definido la variable \$_pagi_sql");
}
...
if($_pagi_conteo_alternativo == false){
    ...
    if($_pagi_result2 == false && $_pagi_mostrar_errores == true){
        die (" Informe ao Administrador - Erro na consulta: $_pagi_sqlConta. Mysql dijo: <b>".mysql_error()."</b>");
    }
    ...
    if($_pagi_result3 == false && $_pagi_mostrar_errores == true){
        die (" Informe ao Administrador - Erro na consulta:: $_pagi_sql. Mysql dijo: <b>".mysql_error()."</b>");
    }
...
if($_pagi_result == false && $_pagi_mostrar_errores == true){
    die ("Informe ao Administrador - Erro na consulta: $_pagi_sqlLim. Mysql dijo: <b>".mysql_error()."</b>");
}
