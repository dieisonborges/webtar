		...
		$dalusuario = new Dalusuario($conexao);
			...
			{		
				...
				$conexao->FechaConexao();
				  ...
				  $tarefaExecutada_LOG='Inclus&aacute;o de Novo Usu&aacute;rio: ('.$nomeCompleto.'-'.$cpf.'-'.$email.'-'.$nomeGuerra.'-'.$saram.'-'.$identidade.'-'.$telefone.'-'.$postoGraduacao.'-'.$tbUnidades_id;
				  $tipoDeTarefa_LOG='INCLUS&Atilde;O DE NOVO USU&Aacute;RIO';			  			  
