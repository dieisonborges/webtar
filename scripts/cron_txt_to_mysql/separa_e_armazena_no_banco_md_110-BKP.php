	...
	while (!feof($ponteiro))
		...
		if(($duracao)and($time!='0'))
			...
			if($dalligacoes->incluirComCilcode($id_central_telefonica, $tbUnidades_id, $tbUsuario_id, $dataLigacao, $time, $duracao, $tipo, $codigo, $troncoEntrada, $troncoSaida, $canalEntrada, $canalSaida, $numDiscado, $numOrigem, $senha, $valor,  $cilcode))
					{
