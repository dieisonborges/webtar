...
<script type="text/javascript">
	...
	{
		url="listagem_minhas_ligacoes_por_dia.php?TxtMesAnoDia=<?php echo $mes_ano_dia; ?>&_pagi_pg="+pag;
		ajax(url);
	}
</script>
<div class="wrap1">
    ...
    <div id="menu">
      ...
      <div class="mainpanel">
        <div class="text_">
          ...
          <?php } ?>
          <div class="text">
		  			<form action="minhas_ligacoes_por_dia.php" method="get" enctype="multipart/form-data">
