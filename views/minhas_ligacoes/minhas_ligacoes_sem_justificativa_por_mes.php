...
<script type="text/javascript">
	...
	{
		url="listagem_minhas_ligacoes_sem_justificativa_por_mes.php?TxtMesAno=<?php echo $mes_ano; ?>&_pagi_pg="+pag;
		ajax(url);
	}
</script>
<div class="wrap1">
    ...
    <div id="menu">
      ...
      <div class="mainpanel">
        <div class="text_">
          ...
          <?php } ?>
          <div class="text">
		  			<form action="minhas_ligacoes_sem_justificativa_por_mes.php" method="get" enctype="multipart/form-data">
