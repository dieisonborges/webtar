        ...
        <div class="text_">
          ...
          <div class="text">
            <form action="../../scripts/usuario/verificar_cadastro.php" method="post" enctype="multipart/form-data" name="validate" id="validate">  
              ...
              <label for="TxtCILCODE" class="labeltxtgeral" style="margin-left:60px;">SIM <input type="radio" value="Y" name="TxtCILCODE" class="input_cad_cilcode" /></label>
              
              <label for="TxtCILCODE" class="labeltxtgeral" style="margin-left:60px;">NÃO <input type="radio" value="N" name="TxtCILCODE" class="input_cad_cilcode" /></label>
