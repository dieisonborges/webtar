        ...
        <div class="text_">
		  ...
		  <form action="../../scripts/usuario/alterar.php" method="post" enctype="multipart/form-data" name="validate" id="validate">
			  ...
			  <select id="unidade" name="TxtUnidade" class="inputsgeraltxt" style="width:80%; float:left;">				  	    		
				  <?php while ($unidades_wh = mysql_fetch_object($rs_unidades)){?>
				  <option value="<?php echo $unidades_wh->id;?>" <?php if(($usuario->tbUnidades_id)==$unidades_wh->id){ echo 'selected="selected"';} ?>> <?php echo ($unidades_wh->sigla);?></option>
				  <?php }?>
			  </select>
			  ...
			  <label for="cilcode" class="labeltxtgeral">Cilcode Principal:</label>
              <input class="inputsgeraltxt" id="cilcode" name="TxtCilcode" type="text" value="<?php echo ($usuario->cilcode);?>">
              
              <label for="cilcodeSecundario" class="labeltxtgeral">Cilcode Secundário:</label>
              <input class="inputsgeraltxt" id="cilcodeSecundario" name="TxtCilcodeSecundario" type="text" value="<?php echo ($usuario->cilcode_2);?>">
              
              <label for="funcional" class="labeltxtgeral">FUNCIONAL:</label>
              <input class="inputsgeraltxt" id="cilcodeSecundario" name="TxtFuncional" type="text" value="<?php echo ($usuario->funcional);?>">
