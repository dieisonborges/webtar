...
<script type="text/javascript">
	...
	{
		url="listagem_ligacoes_por_senha.php?TxtSenha=<?php echo $senha; ?>&_pagi_pg="+pag;
		ajax(url);
	}
</script>
<div class="wrap1">
    ...
    <div id="menu">
      ...
      <div class="mainpanel">
        <div class="text_">
          ...
          <?php } ?>
          <div class="text">
		  			<form action="ligacoes_por_senha.php" method="get" enctype="multipart/form-data">
						<label for="TxtSenha" class="labeltxtgeral">Insira a Senha:</label>
              			<input class="inputsgeraltxtdata" id="nome_usuario" name="TxtSenha" type="text" value="<?php echo $senha; ?>">
