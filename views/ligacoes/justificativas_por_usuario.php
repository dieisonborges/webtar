...
<script type="text/javascript">
	...
	{
		url="listagem_justificativas_por_usuario.php?TxtNomeUsuario=<?php echo $nome_usuario; ?>&_pagi_pg="+pag;
		ajax(url);
	}
</script>
<div class="wrap1">
    ...
    <div id="menu">
      ...
      <div class="mainpanel">
        <div class="text_">
          ...
          <?php } ?>
          <div class="text">
		  			<form action="justificativas_por_usuario.php" method="get" enctype="multipart/form-data">
