		<?php
		  ...
		  $rs_contatelefonica =  $dalcontatelefonica->getPorUsuarioAdm($usuario);
		  ...
		  <tr class="conteudo_tabela_lista_geral">
			...
			<?php while ($contatelefonica = mysql_fetch_object($rs_contatelefonica)){?>
           	  <tr class="conteudo_tabela_lista_geral" style="font-size:12px;">
						...
						<td>
							<?php if(isset($contatelefonica->arquivo)) {
								 echo '<a target="_blank" href="../../private/comprovantes/'.$contatelefonica->arquivo.'">Ver Comprovante de PG</a>'; 
								 }
								 else
								 {
								 echo 'Sem Comprovante de PG';
								 }	 
							?>
