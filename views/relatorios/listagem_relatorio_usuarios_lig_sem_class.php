		  ...
		  if(!isset($usuario->id))
		  	{
		  		...
		  		$rs_ligacoes = $dalligacoes->getTodosUsuarioSemClass($unidades);	
			}
		  else
		  	{
				
				$dalligacoes = new Dalligacoes($conexao);		  
		  		$rs_ligacoes = $dalligacoes->getPorUsuarioSemClass($usuario->id, $unidades);	
			}
         ...
         <table width="100%" id="tabela_lista_geral">
			 <tr class="conteudo_tabela_lista_geral">
              ...
              <tr id="tit_tabela_lista_geral">			  			
                ...
                <td width="29%">Nome</td>
				<td width="13%">Qtd de Lig. n&atilde;o classificadas</td> 
				<td width="11%">Valor R$</td> 
