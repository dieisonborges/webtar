<?php
		  ...
		  // LISTAR USUARIOS QUE NAO JUSTICIFARAM		  
		  $conexao = new Conexao();
		  $dalusuario = new Dalusuario($conexao);
		  $rs_usuario = $dalusuario->getTodosSemAdmSemPagJustPendente($tbUnidades_id, $ano);
		  
		  //PARA LISTAR A UNIDADE ATUAL
		  $conexao = new Conexao();
...
-->
  ...
  <div style="position:absolute;top:289;left:303"><span class="ft0">Usu&aacute;rios com Justificativa Pendente</span></div>
  <div style="position:absolute;top:331;left:10"><span class="ft0">
    <table width="860" border="0" class="tb_relatorio_usuario">
      <tr>
        ...
        <td width="189"><strong>CILCODE</strong></td>
      </tr>
	  ...
	  <tr>
        ...
        <td><?php echo $usuario->cilcode; ?></td>
      </tr>
     <?php }?>
