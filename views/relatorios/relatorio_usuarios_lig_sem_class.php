...
<script type="text/javascript">
	...
	{
		url="listagem_relatorio_usuarios_lig_sem_class.php?TxtNomeUsuario=<?php echo $nome_usuario; ?>&_pagi_pg="+pag;
		ajax(url);
	}
</script>
<div class="wrap1">
  <div class="wrap2">
    ...
    <div id="menu">
      ...
      <div class="mainpanel">
        <div class="text_">
          <h1>Usu&aacute;rios com Ligações sem Classificação </h1>
          ...
          <?php } ?>
          <div class="text">
		  			<form action="relatorio_usuarios_lig_sem_class.php" method="get" enctype="multipart/form-data">
