...
<script type="text/javascript">
	function tarifador(id)
	{
		window.location='../../scripts/usuario_adm/tarifador.php?id='+id;
	}
	function administrador(id)
	{
		window.location='../../scripts/usuario_adm/administrador.php?id='+id;
	}
	function pesquisa(pag)
	{
		url="listagem_to_adm.php?_pagi_pg="+pag+"&TxtUsuario=<?php echo $usuario ;?>";
		ajax(url);
	}
</script>
<div class="wrap1">
    ...
    <div id="menu">
      ...
      <div class="mainpanel">
        <div class="text_">
          ...
          <?php } ?>
          <!--<a class="btn_novo_usuario" href="cadastrar_interno.php">Novo Usuario</a>-->
          <div class="text">
		  			<form action="to_adm.php" method="get" enctype="multipart/form-data">
