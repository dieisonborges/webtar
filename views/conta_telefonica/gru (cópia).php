<?php
	...
	if(!$usuario->cpf)
		...
		*/
		...
		require('../../configuracoes/proxy-gru.php');
		...
		*/
		...
		$file = file_get_contents($url_tesouro);
		echo $file;
die();		
